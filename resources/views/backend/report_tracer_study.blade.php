@extends('backend.layouts', ['activeMenu' => 'REPORT_TRACER_STUDY', 'activeSubMenu' => '', 'title' => 'Report Tracer Study'])
@section('content')
@section('subheader')
<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <!--begin::Page Heading-->
            <div class="d-flex align-items-baseline flex-wrap mr-5 titlePageBreadcrumb"><h5 class="text-dark font-weight-bold my-1 mr-5"><i class="bi bi-file-earmark-post text-dark  mr-1"></i> Report Tracer Study</h5></div>
            <!--end::Page Heading-->
        </div>
        <!--end::Page Heading-->
    </div>
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted"><a href="javascript:void(0);" class="text-muted">Report Tracer Study</a></li>
    </ul>
    <!--end::Breadcrumb-->
    <!--end::Info-->
</div>
...
<div class="container">
    ...
    <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
        ...
        <div class="alert-text">
            Halaman ini berfungsi untuk menampilkan data report tracer study.
        </div>
    </div>
    <!--end::Notice-->
    <!--begin::Row-->
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            Data Report Tracer Study
                        </h3>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt-reportTracer" class="table table-hover table-bordered table-head-custom dtr-inline w-100">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="align-middle text-center">JUMLAH RESPONDEN </th>
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-xl-12" id="card-detail" style="display: none;">
            <!--begin::Card Data Asesor-->
            <div class="card card-custom">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="container mb-2 pt-3 pb-3 pl-10 pr-2 border rounded border-dashed" id="sectionDetailJadwal">
                  
                    </div>
                    <div class="table-responsive">
                        <table id="dt-pesertaTracer" class="table table-hover table-bordered table-head-custom dtr-inline w-100">
                            <thead class="thead-dark">
                                <tr>
                                    <th class="text-center align-middle">No.</th>
                                    <th class="align-middle">NAMA ALUMNI</th>
                                    <th class="align-middle">NIM</th>
                                    <th class="align-middle text-center">JENIS KELAMIN</th>
                                    <th class="align-middle text-center">PRODI</th>
...
@section('js')
<script type="text/javascript" src="{{ asset('script/backend/report_tracer_study.js') }}"></script>
@stop
@endsection
