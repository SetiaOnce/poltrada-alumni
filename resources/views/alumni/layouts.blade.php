...
<head>
    ...
    <title>{{ $title }} - Alumni - {{ $profiles->subname_instansi }}</title>
	<!-- Favicon -->
    ...
    @include('alumni.partials.styles')
</head>
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" class="header-fixed header-mobile-fixed header-bottom-enabled subheader-enabled page-loading" ng-app="routerApp">
		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div id="kt_header" class="header flex-column header-fixed">
					@include('alumni.partials.header')
					@include('alumni.partials.header_nav')
				</div>
				<!--end::Header-->
				<!--begin::Content-->
    ...
    <!--end::Scrolltop-->
    @include('alumni.partials.scripts')
</body>
<!--end::Body-->
</html>